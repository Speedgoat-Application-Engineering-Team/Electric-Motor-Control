...
int32_T PMSM_Plant_Model_e54d855d_1_ds_log(const NeDynamicSystem *LC, const
  NeDynamicSystemInput *t38, NeDsMethodOutput *t39)
{
  ...
  t0[96ULL] = PMSM_Physical_Model_PMSM_Simscape_Model_PMSM_A_v;
  t0[97ULL] = PMSM_Physical_Model_PMSM_Simscape_Model_PMSM_B_v;
  t0[98ULL] = PMSM_Physical_Model_PMSM_Simscape_Model_PMSM_C_v;
  t0[99ULL] = t28;
  t0[100ULL] = X_idx_14;
  t0[101ULL] = X_idx_15;
  t0[102ULL] = X_idx_0;
  ...
  t0[105ULL] = X_idx_9;
  t0[106ULL] = X_idx_0;
  t0[107ULL] = PMSM_Physical_Model_PMSM_Simscape_Model_PMSM_A_v;
  t0[108ULL] = PMSM_Physical_Model_PMSM_Simscape_Model_PMSM_B_v;
  t0[109ULL] = PMSM_Physical_Model_PMSM_Simscape_Model_PMSM_C_v;
  for (t17 = 0ULL; t17 < 12ULL; t17++) {
    t0[t17 + 110ULL] =
  ...
  t0[142ULL] = U_idx_7;
  for (t17 = 0ULL; t17 < 12ULL; t17++) {
    t0[t17 + 143ULL] = ((_NeDynamicSystem*)(LC))->mTable0[t17];
  }
  ...
  t0[179ULL] = PMSM_Physical_Model_PMSM_Simscape_Model_PWM_Peripheral_And_In9;
  t0[180ULL] = -t28;
  t0[181ULL] = X_idx_20;
  t0[182ULL] = X_idx_26;
  t0[183ULL] = X_idx_21;
  ...
  t0[192ULL] = 0.0;
  t0[193ULL] = 24.0;
  t0[194ULL] = -PMSM_Physical_Model_PMSM_Simscape_Model_PWM_Peripheral_And_In9;
  t0[195ULL] = 0.0;
  t0[196ULL] = 24.0;
  t0[197ULL] = 24.0;
  t0[198ULL] = 0.0;
  t0[199ULL] = -t28;
  t0[200ULL] = X_idx_17;
  t0[201ULL] = PMSM_Physical_Model_PMSM_Simscape_Model_PMSM_A_v;
  t0[202ULL] = (-X_idx_17 + X_idx_10) + X_idx_11;
  t0[203ULL] = U_idx_8;
  t0[204ULL] = -X_idx_14;
  t0[205ULL] = X_idx_18;
  t0[206ULL] = PMSM_Physical_Model_PMSM_Simscape_Model_PMSM_B_v;
  t0[207ULL] = (-X_idx_18 + X_idx_10) + X_idx_12;
  t0[208ULL] = U_idx_9;
  t0[209ULL] = -X_idx_15;
  t0[210ULL] = X_idx_19;
  t0[211ULL] = PMSM_Physical_Model_PMSM_Simscape_Model_PMSM_C_v;
  t0[212ULL] = (-X_idx_19 + X_idx_10) + X_idx_13;
  t0[213ULL] = U_idx_10;
  t0[214ULL] = U_idx_2;
  t0[215ULL] = U_idx_3;
  t0[216ULL] = U_idx_4;
  ...
  t0[219ULL] = U_idx_7;
  for (t17 = 0ULL; t17 < 12ULL; t17++) {
    t0[t17 + 220ULL] = -((_NeDynamicSystem*)(LC))->mTable0[t17];
  }
  ...
  t0[252ULL] = U_idx_1;
  t0[253ULL] = -U_idx_1;
  t0[254ULL] = X_idx_0 / -1.0;
  t0[255ULL] = 0.0;
  t0[256ULL] = X_idx_0;
  for (M_idx_0 = 0; M_idx_0 < 257; M_idx_0++) {
